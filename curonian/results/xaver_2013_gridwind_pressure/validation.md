...
| Uostadvaris | 13 | -0.06 | 0.08 | 0.95 | -0.10 | -0 |
...
| Uostadvaris | 4 | -0.10 | 0.11 | 0.95 | -0.10 | -0 |

Flooded land in the delta window (depth > 5 cm, ground > 0 m): **130.1 km²**

### Success criteria (spec section 9)
- C1 Uostadvaris peak [2013-12-05 00:00 to 2013-12-09 00:00]: **met** -- model peak 2013-12-06 05:50, peak err -0.10 m, dt -0.2 h (threshold: peak err within +/-0.15 m and |dt| <= 6 h)
...
- Info: Uostadvaris 8 Dec 06:00 [2013-12-08 06:00]: **info** -- model 0.69 m vs gauge 0.83 m, err -0.14 m (threshold: n/a (context only))
