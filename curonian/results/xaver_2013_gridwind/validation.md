...
|---|---|---|---|---|---|---|
| Klaipeda | 13 | -0.01 | 0.08 | 0.91 | +0.12 | +26 |
| Nida | 26 | -0.01 | 0.10 | 0.77 | -0.09 | +48 |
| Vente | 26 | +0.06 | 0.11 | 0.76 | +0.14 | -60 |
| Uostadvaris | 13 | -0.06 | 0.09 | 0.89 | +0.03 | +0 |
...
| Nida | 8 | -0.02 | 0.14 | 0.42 | -0.13 | +0 |
| Vente | 8 | +0.06 | 0.14 | 0.37 | +0.14 | -60 |
| Uostadvaris | 4 | -0.06 | 0.12 | 0.77 | +0.03 | +0 |

Flooded land in the delta window (depth > 5 cm, ground > 0 m): **140.2 km²**

### Success criteria (spec section 9)
- C1 Uostadvaris peak [2013-12-05 00:00 to 2013-12-09 00:00]: **met** -- model peak 2013-12-06 06:10, peak err +0.03 m, dt +0.2 h (threshold: peak err within +/-0.15 m and |dt| <= 6 h)
