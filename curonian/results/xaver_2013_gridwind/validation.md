...
| Uostadvaris | 13 | -0.00 | 0.04 | 0.96 | +0.01 | +0 |
...
| Uostadvaris | 4 | -0.03 | 0.05 | 0.94 | +0.01 | +0 |

Flooded land in the delta window (depth > 5 cm, ground > 0 m): **130.6 km²**

### Success criteria (spec section 9)
- C1 Uostadvaris peak [2013-12-05 00:00 to 2013-12-09 00:00]: **met** -- model peak 2013-12-06 06:10, peak err +0.01 m, dt +0.2 h (threshold: peak err within +/-0.15 m and |dt| <= 6 h)
...
- Info: Uostadvaris 8 Dec 06:00 [2013-12-08 06:00]: **info** -- model 0.75 m vs gauge 0.83 m, err -0.08 m (threshold: n/a (context only))
